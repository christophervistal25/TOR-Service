...
namespace TOR.API.Migrations
{
    ...
    [Migration("20241203060730_AddRelation")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0284cb1a-bad2-4f6d-8410-e0e78c591fad",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "f81c7d40-a35c-4ae2-b58f-6f59513bf576",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("AccomodationClassification", b =>
                {
                    b.HasOne("Establishment", "Establishment")
                        .WithOne("AccomodationClassification")
                        .HasForeignKey("AccomodationClassification", "EstablishmentId")
